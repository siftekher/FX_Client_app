...
const PlusButton = ({isWhite, style, navigation}) => (
    <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.navigate('Add')}>
      <Image style={{ width: 50, height: 50 }} key={`plus-image-1`} source={require('../assets/images/add-128.png')} />
    </TouchableOpacity>
);
  ...
  renderRight = () => {
    ...
    switch (routeName) {
      ...
      case 'Settings':
        return ([
          <ChatButton key='chat-search' navigation={navigation} isWhite={white} />,
          <BasketButton key='plus-search' navigation={navigation} isWhite={white} />
        ]);
      case 'Product':
        return ([
      ...
      case 'Man':
          return ([
              <PlusButton key='plus-icon1' navigation={navigation} isWhite={white} />
          ]);
      case 'Woman':
          return ([
              <PlusButton key='plus-icon' navigation={navigation} isWhite={white} />
          ]);
      default:
        break;
    }
