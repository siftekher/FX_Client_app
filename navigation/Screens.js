...
import WomanScreen from '../screens/Beneficiaries';
// import ManScreen from '../screens/Man';
import ManScreen from '../screens/Transfers';
...
import BeneficiaryEdit from '../screens/BeneficiaryEdit';
import TransferEdit from "../screens/TransferEdit";
import BeneficiaryAdd from "../screens/BeneficiaryAdd";
import TransferAdd from "../screens/TransferAdd";
...
const WomanStack = createStackNavigator({
  Woman: {
    screen: WomanScreen,
    navigationOptions: ({ navigation }) => ({
      header: <Header title="Beneficiries" navigation={navigation} />,
      headerTransparent: true,
    })
  },
  BeneficiaryEdit: {
    screen: BeneficiaryEdit,
    navigationOptions: ({navigation}) => ({
      header: <Header back title="Beneficiary Edit" navigation={navigation} />,
      // header: <Header back tabs={tabs.beneficiaries} title="" navigation={navigation} />,
      // headerTransparent: true,
    })
  },
  Add: {
        screen: BeneficiaryAdd,
        navigationOptions: ({navigation}) => ({
          header: <Header back title="Add Beneficiary" navigation={navigation} />,
          headerTransparent: true,
        })
  },
...
const ManStack = createStackNavigator({
  Man: {
    screen: ManScreen,
    navigationOptions: ({ navigation }) => ({
      // header: <Header search options title="Transfers" navigation={navigation} />,
      header: <Header title="Transfers" navigation={navigation} />,
      headerTransparent: true,
    })
  },
  TransferEdit: {
  ...
  Add: {
     screen: TransferAdd,
     navigationOptions: ({navigation}) => ({
        header: <Header back title="Add Transfer" navigation={navigation} />,
     })
  },
...
const AppStack = createDrawerNavigator({
    ...
    Woman: {
      ...
      navigationOptions: (navOpt) => ({
        drawerLabel: ({focused}) => (
          <Drawer focused={focused} screen="Woman" title="Beneficiries" />
        ),
      }),
    },
    Man: {
      ...
      navigationOptions: (navOpt) => ({
        drawerLabel: ({focused}) => (
          <Drawer focused={focused} screen="Man" title="Transfers" />
        ),
      }),
    },
    // Kids: {
